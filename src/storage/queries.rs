//! Shared SQL strings for SQLite and PostgreSQL backends.
...
pub mod sqlite {
    ...
    pub const REMOVE_WALLET: &str = "UPDATE wallets SET is_active = 0 WHERE address = ?1";
    ...
    pub const GET_ACTIVE_WALLETS: &str = "SELECT address FROM wallets WHERE is_active = 1";
}
...
pub mod postgres {
    ...
    pub const REMOVE_WALLET: &str = "UPDATE wallets SET is_active = FALSE WHERE address = $1";
    ...
    pub const GET_ACTIVE_WALLETS: &str = "SELECT address FROM wallets WHERE is_active = TRUE";
}
